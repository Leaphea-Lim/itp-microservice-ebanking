...
//                                .logoutUrl("/logout")
//                                .logoutSuccessHandler(redirectToLanding()));
    ...
    //client logout
//    private ServerLogoutSuccessHandler redirectToLanding() {
//        RedirectServerLogoutSuccessHandler handler = new RedirectServerLogoutSuccessHandler();
//
//        handler.setLogoutSuccessUrl(URI.create("/"));  // ← http://localhost:9990/
//        return handler;
//    }
